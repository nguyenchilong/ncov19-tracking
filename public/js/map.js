...
const initCountryList = (countries) => {
    ...
    countries.forEach(country => {
        ...
        totalCasesBadge.innerText = "Cases: " + (country.totalCases || 0);
        totalDeathsBadge.innerText = "Deaths: " + (country.totalDeaths || 0);
        totalRecoveriesBadge.innerText = "Recoveries: " + (country.totalRecoveries || 0);
